...
namespace grabyo::pokerHandComparisonTests{
    ...
    inline void comparisonTests() {
        ...
        assert(pair2.compareWith(pair3) == grabyo::PokerHand::Comparison::Tie);
        ...
        assert(twoPair2.compareWith(pair3) == grabyo::PokerHand::Comparison::Win);
        ...
        assert(flush1.compareWith(straight1) == grabyo::PokerHand::Comparison::Win);
        ...
        assert(straightFlush1.compareWith(quads1) == grabyo::PokerHand::Comparison::Win);
        ...
        assert(pair1.compareWith(straightFlush2) == grabyo::PokerHand::Comparison::Loss);
